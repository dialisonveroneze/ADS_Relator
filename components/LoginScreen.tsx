...
const LoginScreen: React.FC = () => {
    ...
    const handleGoogleClick = (e: React.MouseEvent) => {
        if (GOOGLE_CLIENT_ID.includes('INSIRA_SEU_CLIENT_ID') || GOOGLE_CLIENT_ID.includes('SEU_CLIENT_ID')) {
            e.preventDefault();
            alert("Erro de Configuração: Você precisa configurar o GOOGLE_CLIENT_ID no arquivo LoginScreen.tsx com a chave gerada no Google Cloud.");
        }
    };
